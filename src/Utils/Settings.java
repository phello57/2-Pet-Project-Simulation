...
public class Settings {
    ...
    public static Entity getEntityOnCoordinate(int pWidth, int pLength) {
        return MAP_GAME_MAP[pWidth][pLength].getEntity();
    }
    ...
    private static final int SPAWN_GRASS = 14;
    private static final int SPAWN_PIG = 4;
    private static final int SPAWN_ROCK = 17;
    private static final int SPAWN_TREE = 10;
    ...
    public static void setNodeMapGame(int pWidth, int pLength, Node pNode) {
        MAP_GAME_MAP[pWidth][pLength] = pNode;
    }
